...
def load_and_preprocess_mimic(path="data/MIMIC-IV.dta", batch_size=512, test_size=0.3, seed=42):
    ...
    data = data.rename(
        ...
        "aki": "AKI n (%)",
        "stroke": "Beroerte n (%)",
        "AISAN": "Afkomst: Aziatisch",
        "BLACK": "Afkomst: Afrikaans",
        "HISPANIC": "Afkomst: Latijns-amerikaans",
        "OTHER": "Afkomst: Anders",
        "WHITE": "Afkomst: Europees/Westers",
        "unknown": "Afkomst: Onbekend",
        "CCU": "ICU Type: CCU",
