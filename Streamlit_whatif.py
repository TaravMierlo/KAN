...
with column1:
    ...
    with st.expander("ℹ️ **Belang van kenmerken voor individuele voorspelling**"):
        st.write("Deze grafiek laat zien hoe verschillende patiëntkenmerken bijdragen aan de voorspelling voor een specifieke patiënt.")
        st.markdown("- **Bovenste grafiek**: Toont de som van alle bijdragen van kenmerken. De balk geeft de som van bijdragen die het risico op SAD verhogen en de rode stippellijn duidt de drempelwaarde aan tussen wel of geen SAD. In dit geval is de som **0.4507**, hoger dan de drempelwaarde van **0.2361**, dus is het advies: *Geen SAD*")
...
with column2:
    ...
    with st.expander("ℹ️ **Effect van individuele variabele op het advies**"):
        ...
        st.markdown("- **Blauwe punten** geven waarden die kans op SAD **verlagen**.")
        st.markdown("- **Oranje punten** geven waarden die kans op SAD **verhogen**.")
